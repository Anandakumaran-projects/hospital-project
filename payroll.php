...
<body>
	<form action="./backend/payroll.php" method="post" onsubmit="return submitform(this);">
		<div class="container">
			<h2>Payroll And Compensation</h2>
			...
			<div class="row2">
				...
				<input type="text" name="rate" id="rate" class="a3">
				<label for="frequency" class="label">Frequency:</label>
				<input type="text" name="frequency" id="frequency" class="a4">
			</div>
			<div class="row3">
				<label for="paydate" class="label">Pay Date:</label>
				<input type="date" name="paydate" id="paydate" class="a5">
				<label for="paymentstatus" class="label">Payment Status:</label>
				<select id="paymentstatus" name="paymentstatus" class="a6">
