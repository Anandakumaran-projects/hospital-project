...
<head>
	...
	<link rel="stylesheet" href="css/vitalsign.css">
...
<body>
	<form action="./backend/vitalsign.php" method="post"  onsubmit="return submitform(this);">
		<div class="container">
			<h2>Vital Sign Process</h2>
			<hr style="border-bottom:2px solid #fff;">
			<div class="row1">
				<label for="height" class="label">Height:</label>
				<input type="text" name="height" id="height" class="a1">
				<label for="weight" class="label">Weight:</label>
				<input type="text" name="weight" id="weight" class="a2">
			</div>
			<div class="row2">
				<label for="pressure" class="label">Blood Pressure:</label>
				<input type="text" name="pressure" id="pressure" class="a3">
				<label for="temp" class="label">Temperature:</label>
				<input type="text" name="temp" id="temp" class="a4">
			</div>
			<div class="row3">
				<label for="pulse" class="label">Pulse:</label>
				<select id="pulse" name="pulse" class="a5">
